...
| 功能 | 测试组 | 对照组 | 样本量 |
|------|-------|-------|--------|
| 降级提示 Alert | 显示 | 不显示 | 每组 50 次 |
| 知识级别标签 | 显示 | 不显示 | 每组 50 次 |
| 条件化重新评估 | 启用 | 不启用 | 每组 50 次 |
...
| 阶段 | 时间 | 内容 |
|------|------|------|
| **准备期** | 2026-06-19 | 埋点开发、看板搭建 |
| **预热期** | 2026-06-20 | 小流量测试（10%） |
| **正式期** | 2026-06-21 ~ 2026-06-27 | 全流量测试（50%/50%） |
| **分析期** | 2026-06-28 | 数据统计、显著性检验 |
| **决策期** | 2026-06-29 | 根据结果决定是否全量 |
