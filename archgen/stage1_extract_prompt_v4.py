...
def build_stage1_prompt(article_content: str) -> Tuple[str, str]:
    """返回 (system_prompt, user_prompt) 用于 LLM 调用。"""
    return SYSTEM_PROMPT, USER_PROMPT_TEMPLATE.format(article_content=article_content)
