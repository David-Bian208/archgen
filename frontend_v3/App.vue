<template>
  <div class="app-container">
      ...
      <div class="chat-container">
        <div class="chat-messages" ref="messagesContainer">
          ...
          <div v-if="insightReport" class="insight-report v35-report">
            ...
            <!-- 三、我们的第一步计划（V3.5 核心） -->
            <div v-if="interventionPlan" class="report-section intervention-plan">
              <h3>三、我们的第一步计划：{{ interventionPlan.phase_name }}</h3>
              
              <div class="plan-details">
                <div class="plan-item">
                  <h4>🎯 目标</h4>
                  <p>{{ interventionPlan.goal }}</p>
                </div>
                
                <div class="plan-item">
                  <h4>🎮 具体怎么玩（策略）</h4>
                  <p class="gamified-strategy">{{ interventionPlan.strategy_details_gamified || interventionPlan.strategy_details }}</p>
                </div>
                
                <div class="plan-item">
                  <h4>✅ 如何知道有效（成功标准）</h4>
                  <p class="success-criteria">{{ interventionPlan.success_criteria }}</p>
                </div>
                
                <!-- V3.5 新增：第一个小目标 -->
                <div v-if="interventionPlan.mini_goal" class="plan-item mini-goal">
                  <h4>🏆 我们的第一个小目标</h4>
                  <p class="mini-goal-text"><strong>目标：</strong>{{ interventionPlan.mini_goal }}</p>
                </div>
                
                <!-- V3.5 新增：观察记录小工具 -->
                <div v-if="interventionPlan.observation_tool" class="plan-item observation-tool">
                  <h4>📋 您的观察记录小工具</h4>
    ...
    <footer class="footer">
      <p>Behavior Recorder V3.5 | 决策支持系统</p>
    </footer>
  </div>
</template>
